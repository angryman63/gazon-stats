...
.hero-title { font-family: 'Oswald', sans-serif; font-size: 36px; font-weight: 700; color: #ffffff; line-height: 1.1; margin: 0 0 8px 0; white-space: nowrap; }
.hero-title span { color: #c8a84b; }
.hero-subtitle { font-family: 'Raleway', sans-serif; font-size: 17px; color: #aaaaaa; line-height: 1.6; margin: 0 auto 40px auto; max-width: 640px; text-align: center !important; }
...
.feature-desc { font-family: 'Raleway', sans-serif; font-size: 13px; color: #888888; line-height: 1.5; margin: 0; }
